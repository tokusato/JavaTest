...
public class MySQLParser extends Parser {
	...
	public static final int
		...
		WHERE=3, EQ=37, USING=52, RBRACK=33, NOT=41, LIKE=9, LBRACK=34, AND=4,
		GET=43, XOR=6, KEY=54, PLUS=20, LTH=38, USER_VAR=72, BINARY=26, SEMI=44,
		ANY=13, IGNORE=60, INT=69, DIVIDE=16, ORDER=55, GROUP=56, NATURAL=63,
		REGEXP=19, BY=57, STRAIGHT_JOIN=62, RIGHT=65, OUTER=49, OJ=66, WS=71,
		ON=67, COMMA=45, BITAND=24, OR=5, MOD=17, VERTBAR=23, EXISTS=11, COLLATE=47,
		USE=59, NEGATION=22, ASTERISK=30, COLON=35, SELECT=1, SHIFT_RIGHT=28,
	...
	public final Column_nameContext column_name() throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				if (_la==ID) {
					{
					setState(112); column_name_alias();
					}
				}
			...
			case 3:
				...
				{
				setState(121); match(USER_VAR);
				setState(123);
				_la = _input.LA(1);
				if (_la==ID) {
					{
					setState(122); column_name_alias();
					}
				}
	...
	public final ExpressionContext expression() throws RecognitionException {
		...
		try {
			...
			enterOuterAlt(_localctx, 1);
			{
			setState(164); simple_expression();
			setState(170);
			_errHandler.sync(this);
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					{
					{
					setState(165); expr_op();
					setState(166); simple_expression();
					}
					}
				}
				setState(172);
	...
	public final ElementContext element() throws RecognitionException {
		...
		try {
			...
			case 3:
				...
				{
				{
				setState(175); match(VERTBAR);
				setState(176); match(ID);
				setState(177); match(VERTBAR);
				}
				}
				break;
			case 4:
	...
	public final Is_or_is_notContext is_or_is_not() throws RecognitionException {
		...
		try {
			...
			case 1:
				enterOuterAlt(_localctx, 1);
				{
				setState(194); match(IS);
				}
				break;
			case 2:
				enterOuterAlt(_localctx, 2);
				{
				setState(195); match(IS);
	...
	public final Simple_expressionContext simple_expression() throws RecognitionException {
		...
		try {
			...
			case 1:
				enterOuterAlt(_localctx, 1);
				{
				setState(199); left_element();
				setState(200); relational_op();
				setState(201); right_element();
				}
				break;
			case 2:
				enterOuterAlt(_localctx, 2);
				{
				setState(203); target_element();
				setState(204); between_op();
				setState(205); left_element();
				setState(206); match(AND);
				setState(207); right_element();
				}
				break;
			case 3:
				enterOuterAlt(_localctx, 3);
				{
				setState(209); target_element();
				setState(210); is_or_is_not();
				setState(211); match(NULL);
				}
				break;
			}
		}
	...
	public final Table_referenceContext table_reference() throws RecognitionException {
		...
		try {
			...
			case 1:
				enterOuterAlt(_localctx, 1);
				{
				setState(224); table_factor1();
				}
				break;
			case 2:
				enterOuterAlt(_localctx, 2);
				{
				setState(225); table_atom();
				}
				break;
			}
		}
	...
	public final Table_factor1Context table_factor1() throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				setState(233); table_atom();
				setState(235);
				switch ( getInterpreter().adaptivePredict(_input,20,_ctx) ) {
				case 1:
					{
					setState(234); join_condition();
					}
					break;
				}
				}
	...
	public final Table_factor2Context table_factor2() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(239); table_factor3();
			setState(246);
			switch ( getInterpreter().adaptivePredict(_input,23,_ctx) ) {
			case 1:
				{
				setState(240); match(STRAIGHT_JOIN);
				setState(241); table_atom();
				setState(244);
				switch ( getInterpreter().adaptivePredict(_input,22,_ctx) ) {
				case 1:
					{
					setState(242); match(ON);
	...
	public final Table_factor3Context table_factor3() throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				if (_la==OUTER) {
					{
					setState(250); match(OUTER);
					}
				}

				setState(253); match(JOIN);
				setState(254); table_factor4();
				setState(255); join_condition();
				}
				break;
			}
			}
	...
	public final Table_factor4Context table_factor4() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(259); table_atom();
			setState(269);
			switch ( getInterpreter().adaptivePredict(_input,28,_ctx) ) {
			case 1:
				{
				setState(260); match(NATURAL);
				setState(265);
				_la = _input.LA(1);
				if (_la==LEFT || _la==RIGHT) {
					{
				...
				setState(267); match(JOIN);
				setState(268); table_atom();
				}
				break;
			}
			}
	...
	public final Table_atomContext table_atom() throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				{
				{
				setState(271); table_name();
				setState(273);
				_la = _input.LA(1);
				if (_la==PARTITION) {
					{
					setState(272); partition_clause();
					}
				}
			...
			case 2:
				...
				{
				{
				setState(281); subquery();
				setState(282); subquery_alias();
				}
				}
				break;
			case 3:
			...
			case 4:
				...
				{
				{
				setState(288); match(OJ);
				setState(289); table_reference();
				setState(290); match(LEFT);
				setState(291); match(OUTER);
				setState(292); match(JOIN);
				setState(293); table_reference();
				setState(294); match(ON);
	...
	public final Join_clauseContext join_clause() throws RecognitionException {
		...
		try {
			...
			case CROSS:
				...
				setState(302); match(JOIN);
				setState(303); table_atom();
				setState(305);
				_la = _input.LA(1);
				if (_la==USING || _la==ON) {
					{
					setState(304); join_condition();
					}
				}
			...
			case STRAIGHT_JOIN:
				...
				{
				{
				setState(307); match(STRAIGHT_JOIN);
				setState(308); table_atom();
				setState(311);
				_la = _input.LA(1);
				if (_la==ON) {
					{
			...
			case RIGHT:
				...
				if (_la==OUTER) {
					{
					setState(314); match(OUTER);
					}
				}

				setState(317); match(JOIN);
				setState(318); table_factor4();
				setState(319); join_condition();
				}
				}
				break;
			case NATURAL:
				...
				setState(328); match(JOIN);
				setState(329); table_atom();
				}
				}
				break;
			default:
	...
	public final Join_conditionContext join_condition() throws RecognitionException {
		...
		try {
			...
			case USING:
				...
				{
				{
				setState(342); match(USING);
				setState(343); column_list();
				}
				}
				break;
			default:
		...
		try {
			...
			if (_la==FOR) {
				...
				case ORDER:
					{
					{
					setState(357); match(ORDER);
					setState(358); match(BY);
					}
					}
					break;
				case GROUP:
					{
					{
					setState(359); match(GROUP);
					setState(360); match(BY);
					}
					}
					break;
				default:
	...
	public final Index_hintContext index_hint() throws RecognitionException {
		...
		try {
			...
			case USE:
				enterOuterAlt(_localctx, 1);
				{
				setState(365); match(USE);
				setState(366); index_options();
				setState(367); match(LPAREN);
				setState(369);
				_la = _input.LA(1);
				if (_la==ID) {
					{
					setState(368); index_list();
					}
				}
			...
			case IGNORE:
				enterOuterAlt(_localctx, 2);
				{
				setState(373); match(IGNORE);
				setState(374); index_options();
				setState(375); match(LPAREN);
				setState(376); index_list();
	...
	public final Partition_clauseContext partition_clause() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(389); match(PARTITION);
			setState(390); match(LPAREN);
			setState(391); partition_names();
